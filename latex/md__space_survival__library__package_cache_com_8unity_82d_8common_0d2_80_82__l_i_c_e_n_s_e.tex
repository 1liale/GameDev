{\bfseries{\mbox{\hyperlink{namespace_unity}{Unity}} Companion Package License v1.\+0 (\char`\"{}\+\_\+\+License\+\_\+\char`\"{})}}

Copyright © 2019 \mbox{\hyperlink{namespace_unity}{Unity}} Technologies ApS (\char`\"{}$\ast$$\ast$\+\_\+\+Unity\+\_\+$\ast$$\ast$\char`\"{})
